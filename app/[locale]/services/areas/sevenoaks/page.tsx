...
export const metadata: Metadata = {
  title: 'Domestic Abuse Solicitors in Sevenoaks | CVG Family Law',
  description: 'Expert domestic abuse solicitors in Sevenoaks, Kent. Emergency protection orders, non-molestation orders & urgent legal support. Free consultation. SRA regulated.',
  keywords: [
    'domestic abuse solicitor Sevenoaks',
    'emergency injunction Sevenoaks',
    'non-molestation order Sevenoaks',
    'protection order Kent',
    'family law Sevenoaks',
    'emergency legal help Sevenoaks',
    'restraining order Sevenoaks',
    'occupation order Sevenoaks',
    'domestic violence lawyer Kent',
    'urgent family law Sevenoaks'
  ],
  openGraph: {
    title: 'Domestic Abuse Solicitors in Sevenoaks | CVG Family Law',
    description: 'Expert domestic abuse legal support in Sevenoaks. 24/7 emergency consultations, protection orders & compassionate representation. SRA regulated.',
    url: `${siteConfig.url}/services/areas/sevenoaks`,
  ...
  twitter: {
    ...
    title: 'Domestic Abuse Solicitors Sevenoaks | CVG Family Law',
    description: 'Urgent domestic abuse legal support in Sevenoaks. Emergency protection orders & expert family law representation.',
  },
  alternates: {
    canonical: `${siteConfig.url}/services/areas/sevenoaks`,
  },
};

export default function SevenoaksServiceArea() {
  return (
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            Domestic Abuse Solicitors in Sevenoaks
          </h1>
          <p className="text-xl text-gray-600 mb-6">
            Expert legal protection and support for victims of domestic abuse in Sevenoaks and surrounding Kent areas
          </p>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <p className="text-gray-600 mb-4">
              Immediate legal protection for domestic abuse victims in Sevenoaks.
        ...
        <div className="bg-gray-50 rounded-lg p-8 mb-12">
          <h2 className="text-2xl font-semibold text-gray-900 mb-6">
            Serving Sevenoaks & Kent
          </h2>
          <div className="grid md:grid-cols-3 gap-6">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Local Courts</h3>
              <p className="text-gray-600">
                Sevenoaks Magistrates Court, Maidstone Crown Court, and all Kent family courts
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Police Stations</h3>
              <p className="text-gray-600">
                Sevenoaks Police Station, Tonbridge Police, and Kent Police domestic abuse units
              </p>
            </div>
            <div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-8 mb-12">
          <h2 className="text-2xl font-semibold text-gray-900 mb-6 text-center">
            Why Choose CVG Family Law in Sevenoaks?
          </h2>
        ...
        <div className="text-center bg-primary-600 text-white rounded-lg p-8">
          <h2 className="text-2xl font-bold mb-4">
            Need Urgent Legal Help in Sevenoaks?
          </h2>
