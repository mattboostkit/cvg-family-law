...
export const metadata: Metadata = {
  title: 'Domestic Abuse Solicitors in Tunbridge Wells | CVG Family Law',
  description: 'Expert domestic abuse solicitors in Tunbridge Wells, Kent. Emergency protection orders, non-molestation orders & urgent legal support. Free consultation. SRA regulated.',
  keywords: [
    'domestic abuse solicitor Tunbridge Wells',
    'emergency injunction Tunbridge Wells',
    'non-molestation order Tunbridge Wells',
    'protection order Kent',
    'family law Tunbridge Wells',
    'emergency legal help Tunbridge Wells',
    'restraining order Tunbridge Wells',
    'occupation order Tunbridge Wells',
    'domestic violence lawyer Kent',
    'urgent family law Tunbridge Wells'
  ],
  openGraph: {
    title: 'Domestic Abuse Solicitors in Tunbridge Wells | CVG Family Law',
    description: 'Expert domestic abuse legal support in Tunbridge Wells. 24/7 emergency consultations, protection orders & compassionate representation. SRA regulated.',
    url: `${siteConfig.url}/services/areas/tunbridge-wells`,
  ...
  twitter: {
    ...
    title: 'Domestic Abuse Solicitors Tunbridge Wells | CVG Family Law',
    description: 'Urgent domestic abuse legal support in Tunbridge Wells. Emergency protection orders & expert family law representation.',
  },
  alternates: {
    canonical: `${siteConfig.url}/services/areas/tunbridge-wells`,
  },
};

export default function TunbridgeWellsServiceArea() {
  return (
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            Domestic Abuse Solicitors in Tunbridge Wells
          </h1>
          <p className="text-xl text-gray-600 mb-6">
            Expert legal protection and support for victims of domestic abuse in Tunbridge Wells and surrounding Kent areas
          </p>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <p className="text-gray-600 mb-4">
              Immediate legal protection for domestic abuse victims in Tunbridge Wells.
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <p className="text-gray-600 mb-4">
              Crisis situations don&apos;t wait for office hours. We&apos;re available around the clock
        ...
        <div className="bg-gray-50 rounded-lg p-8 mb-12">
          <h2 className="text-2xl font-semibold text-gray-900 mb-6">
            Serving Tunbridge Wells & Kent
          </h2>
          <div className="grid md:grid-cols-3 gap-6">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Local Courts</h3>
              <p className="text-gray-600">
                Tunbridge Wells County Court, Maidstone Crown Court, and all Kent family courts
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Police Stations</h3>
              <p className="text-gray-600">
                Tunbridge Wells Police Station, Sevenoaks Police, and Kent Police domestic abuse units
              </p>
            </div>
            <div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-8 mb-12">
          <h2 className="text-2xl font-semibold text-gray-900 mb-6 text-center">
            Why Choose CVG Family Law in Tunbridge Wells?
          </h2>
        ...
        <div className="text-center bg-primary-600 text-white rounded-lg p-8">
          <h2 className="text-2xl font-bold mb-4">
            Need Urgent Legal Help in Tunbridge Wells?
          </h2>
