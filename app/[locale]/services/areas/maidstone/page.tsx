...
export const metadata: Metadata = {
  title: 'Domestic Abuse Solicitors in Maidstone | CVG Family Law',
  description: 'Expert domestic abuse solicitors in Maidstone, Kent. Emergency protection orders, non-molestation orders & urgent legal support. Free consultation. SRA regulated.',
  keywords: [
    'domestic abuse solicitor Maidstone',
    'emergency injunction Maidstone',
    'non-molestation order Maidstone',
    'protection order Kent',
    'family law Maidstone',
    'emergency legal help Maidstone',
    'restraining order Maidstone',
    'occupation order Maidstone',
    'domestic violence lawyer Kent',
    'urgent family law Maidstone'
  ],
  openGraph: {
    title: 'Domestic Abuse Solicitors in Maidstone | CVG Family Law',
    description: 'Expert domestic abuse legal support in Maidstone. 24/7 emergency consultations, protection orders & compassionate representation. SRA regulated.',
    url: `${siteConfig.url}/services/areas/maidstone`,
  ...
  twitter: {
    ...
    title: 'Domestic Abuse Solicitors Maidstone | CVG Family Law',
    description: 'Urgent domestic abuse legal support in Maidstone. Emergency protection orders & expert family law representation.',
  },
  alternates: {
    canonical: `${siteConfig.url}/services/areas/maidstone`,
  },
};

export default function MaidstoneServiceArea() {
  return (
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            Domestic Abuse Solicitors in Maidstone
          </h1>
          <p className="text-xl text-gray-600 mb-6">
            Expert legal protection and support for victims of domestic abuse in Maidstone and surrounding Kent areas
          </p>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <p className="text-gray-600 mb-4">
              Immediate legal protection for domestic abuse victims in Maidstone.
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div>
              ...
              <p className="text-gray-600">
                Maidstone County Court, Maidstone Crown Court, and all Kent family courts
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Police Stations</h3>
              <p className="text-gray-600">
                Maidstone Police Station, and Kent Police domestic abuse units
              </p>
            </div>
            <div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-8 mb-12">
          <h2 className="text-2xl font-semibold text-gray-900 mb-6 text-center">
            Why Choose CVG Family Law in Maidstone?
          </h2>
        ...
        <div className="text-center bg-primary-600 text-white rounded-lg p-8">
          <h2 className="text-2xl font-bold mb-4">
            Need Urgent Legal Help in Maidstone?
          </h2>
